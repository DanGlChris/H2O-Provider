...
public interface M {
    ...
    /**
     * cette methode permet de recadrer un stage en fonction d'un autre stage plus grand que lui
     * @param reference
     * @param stage 
     */
    ...
    /**
     * cette methode permet de passer d'un stage a un autre
     * @param stage1
     * @param stage2
    ...
    public static void Change_Stage(Stage stage1, Stage stage2, boolean sens){
        if(sens){
            stage2.show();
            Data.M.RecadrerStage(stage1, stage2);
            stage1.close();
        }else{
            stage1.show();
            Data.M.RecadrerStage(stage2, stage1);
            stage2.close();
        }
    }
}
